...
│  │                       │  │                       │   │
│  │   12 족보             │  │   14 족보             │   │  ← 족보 수
│  │   3롤 · 보너스 63점   │  │   4롤 · 보너스 108점  │   │  ← 굴림+보너스 임계
...
카드 컨테이너:
  role            : "button"
  tabIndex        : 0
  aria-label      : "D6 정육면체 모드 선택, 12 족보, 3롤, 보너스 63점"
                   "D8 정팔면체 모드 선택, 14 족보, 4롤, 보너스 108점"
...
D6 표기는 기존 명세 그대로 "/63". D8은 "/108"로 표기.
달성/미달 색상 판정 기준값: D6=63, D8=108 (서버가 bonusEarned 플래그로 알림).
