...
export const STAGE_CONFIGS: StageConfig[] = [
  { rows: 3, cols: 9,  d1: 27, d2:  0, d3:  0, items: 0, speedDx: 2.5, speedDy: -3.0 },
  { rows: 4, cols: 9,  d1: 34, d2:  0, d3:  0, items: 2, speedDx: 2.8, speedDy: -3.2 },
  { rows: 4, cols: 9,  d1: 18, d2: 16, d3:  0, items: 2, speedDx: 3.0, speedDy: -3.4 },
  { rows: 5, cols: 9,  d1: 21, d2:  8, d3:  0, items: 2, speedDx: 3.2, speedDy: -3.6 },
  { rows: 5, cols: 9,  d1: 28, d2: 13, d3:  0, items: 4, speedDx: 3.4, speedDy: -3.8 },
  { rows: 6, cols: 9,  d1: 24, d2: 16, d3:  4, items: 4, speedDx: 3.6, speedDy: -4.0 },
  { rows: 6, cols: 10, d1: 24, d2: 20, d3: 10, items: 6, speedDx: 3.8, speedDy: -4.2 },
  { rows: 6, cols: 10, d1: 14, d2: 28, d3: 18, items: 0, speedDx: 4.0, speedDy: -4.4 },
  { rows: 7, cols: 10, d1: 26, d2: 28, d3: 12, items: 4, speedDx: 4.2, speedDy: -4.6 },
  { rows: 7, cols: 10, d1: 18, d2: 32, d3: 20, items: 0, speedDx: 4.5, speedDy: -4.8 },
];
