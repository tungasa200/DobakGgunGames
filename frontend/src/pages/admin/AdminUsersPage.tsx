...
const ROLE_LABELS: Record<string, string> = { USER: '일반', FRIEND: '도박꾼', ADMIN: '관리자' };
...
const ROLE_BADGE: Record<string, string> = {
  USER: s.badgeGray, FRIEND: s.badgePurple, ADMIN: s.badgeBlue,
};
    ...
    <div className={s.page}>
      ...
      <div className={s.toolbar}>
        ...
        <select className={s.select} value={roleFilter} onChange={e => { setRoleFilter(e.target.value); setPage(0); }}>
          ...
          <option value="FRIEND">도박꾼</option>
